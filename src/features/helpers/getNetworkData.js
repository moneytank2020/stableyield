...
const networkTxUrls = {
  ...
  31337: hash => `https://ftmscan.com/tx/${hash}`,
  4002: hash => `https://ftmscan.com/tx/${hash}`,
...
const networkBuyUrls = {
  ...
  31337: 'https://spookyswap.finance/swap?inputCurrency=0x04068da6c83afcfa0e13ba15a6696662335d5b75&outputCurrency=0xd6070ae98b8069de6B494332d1A1a81B6179D960',
  4002: 'https://spookyswap.finance/swap?inputCurrency=0x04068da6c83afcfa0e13ba15a6696662335d5b75&outputCurrency=0xd6070ae98b8069de6B494332d1A1a81B6179D960',
      ...
      return {
        ...
        providerOptions: {
          ...
          'custom-clover-fantom': {
            ...
            options: {
              supportedChainIds: [250, 31337, 4002],
            },
            package: CloverConnector,
            connector: async (ProviderPackage, options) => {
              const provider = new ProviderPackage(options);
          ...
          'custom-cb-ftm': {
            ...
            connector: async (ProviderPackage, options) => {
              ...
              const provider = walletLink.makeWeb3Provider('https://rpc.ftm.tools/', 4002);
